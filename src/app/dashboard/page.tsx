...
import { Wallet, ArrowUpRight, Activity, BarChart3, CreditCard } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const transactions = [
    { id: 'TX_8f7d3e2a', date: 'May 15, 2023 14:30', amount: '250.00', currency: 'USDT', status: 'completed' as const },
    { id: 'TX_6e9c5b7a', date: 'May 14, 2023 09:12', amount: '1,500.00', currency: 'USDC', status: 'completed' as const },
    { id: 'TX_4d2a9f8c', date: 'May 13, 2023 17:45', amount: '0.75', currency: 'ETH', status: 'pending' as const },
    { id: 'TX_1b3c7d9e', date: 'May 12, 2023 11:20', amount: '890.50', currency: 'USDT', status: 'failed' as const },
    { id: 'TX_5a8e2f1b', date: 'May 11, 2023 16:05', amount: '350.00', currency: 'USDC', status: 'completed' as const },
  ] as const;
